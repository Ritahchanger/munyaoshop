    ...
    return ( 
        <footer>
            <div className="footer__container">
                    ...
                    <div className="footer__contact__container">
                        ...
                        <ul className="footer__contacts">
                            <li className="footer__contact">
                                <LocalPhoneIcon /> <span>+254113174493</span>
                            </li>
                            <li className="footer__contact">
                                <EmailIcon /> <span>shop@munyao.com</span>
                            </li>
                            <li className="footer__contact">
                                <LocationOnIcon /> <span>Meru Kenya</span>
                            </li>
                        </ul>
                    </div>
                ...
                <ul className='nav'>
                        <li className="footer__copyright">©2024 Denno Ltd. |</li>
